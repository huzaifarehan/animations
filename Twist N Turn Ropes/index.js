const ropeGradientStart = getComputedStyle(document.documentElement).getPropertyValue('--rope-gradient-start');
const ropeGradientEnd = getComputedStyle(document.documentElement).getPropertyValue('--rope-gradient-end');
...
class Stick {
    ...
    draw(ctx) {
        const gradient = ctx.createLinearGradient(this.startPoint.pos.x, this.startPoint.pos.y, this.endPoint.pos.x, this.endPoint.pos.y);
        gradient.addColorStop(0, ropeGradientStart);
        gradient.addColorStop(1, ropeGradientEnd);
        ctx.beginPath()
